...
class Config:
    def __init__(self, config_file=None):
        self.parser = self.read_setup_file(config_file)

    def read_setup_file(self, config_file):
        logger = logging.getLogger('jsahfda')
        ...
        if not os.path.isfile(config_file):
            ...
            with open(config_file, "r") as updated_file:
                parser.readfp(updated_file)
        return parser
    ...
    def getint(self, section, parameter):
        return self.parser.getint(section, parameter)

    def getboolean(self, section, parameter):
        return self.parser.getboolean(section, parameter)

    def set(self, section, parameter, destination):
        self.parser.set(section, parameter, destination)

    def getColorWheel(self):
        num_clusters = self.parser.getint(PREPROCESSING_CONSTANTS, "num_clusters")
        color_wheel = Config._coloringFeatures(num_clusters)
        return color_wheel

    @staticmethod
    def getFullColorWheel():
        return Config._coloringFeatures(30)
    ...
    def _coloringFeatures(num_clusters):
        ...
        colors = {0: {6: "#b79c29", 5: "#bea53e", 4: "#c5af53", 3: "#ccb969", 2: "#d3c37e", 1: "#dbcd94", 0: "#e2d7a9",
                  ...
                  2: {6: "#7eab2b", 5: "#8ab340", 4: "#97bb55", 3: "#a4c46a", 2: "#b1cc7f", 1: "#bed595", 0: "#cbddaa",
                      7: "#d8e5bf"},
                  3: {6: "#f10e0a", 5: "#f6221e", 4: "#f73a36", 3: "#f8524f", 2: "#f96a68", 1: "#fa8280", 0: "#fb9a99",
                      7: "#fcb2b2"},
                  4: {6: "#4f3b73", 5: "#5a4484", 4: "#664c95", 3: "#7155a6", 2: "#7f65b0", 1: "#8d75b9", 0: "#9b86c1",
                      7: "#a997ca"},
                  5: {6: "#bd890b", 5: "#d59a0d", 4: "#edac0e", 3: "#f2b523", 2: "#f3bd3b", 1: "#f5c553", 0: "#f6cd6b",
                      7: "#f7d583"},
                  6: {6: "#175197", 5: "#1a5dad", 4: "#1e69c3", 3: "#2175d9", 2: "#3382e0", 1: "#4a90e3", 0: "#609de7",
                      7: "#76abea"},
...
# Config = Config("./defaultconfig.txt")
# print(Config.parser.get("ExternalFiles", "names_with_id"))
